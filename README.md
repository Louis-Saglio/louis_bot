...
Copy this directory into your 0 A.D. mods folder (e.g. `~/.local/share/0ad/mods/louis_bot`), enable the mod, and select the "Louis — bot" AI for a player in the game setup.
